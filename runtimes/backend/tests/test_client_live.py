...
These tests require a working config/config.yaml with valid API credentials.
...
from src.client import InsightFlowClient, StreamEvent
...
def client():
    """Create a real InsightFlowClient (no mocks)."""
    return InsightFlowClient(thinking_enabled=False)

...
class TestChannelManager:
    ...
    def test_each_message_creates_new_thread(self):
        """Every chat message should create a new lumen thread (one-shot Q&A)."""
        from src.channels.manager import ChannelManager
    ...
    def test_same_topic_reuses_thread(self):
        """Messages with the same topic_id should reuse the same lumen thread."""
        from src.channels.manager import ChannelManager
    ...
    def test_extracts_from_present_files_tool_call(self):
        ...
        result = {
            "messages": [
                ...
                {"type": "tool", "name": "present_files", "content": "Presented files: report.md"},
            ]
        }

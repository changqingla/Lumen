  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black text-white font-mono font-semibold selection:bg-cyan-500 selection:text-black">
      ...
      <div className="absolute inset-0 z-10 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-10 md:p-20 flex flex-col justify-between pointer-events-none select-none relative overflow-hidden">
          ...
          <div className="z-20">
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] mix-blend-difference">
              Lumen
              <span className="block text-2xl md:text-3xl font-light tracking-[0.35em] text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-sky-300 to-blue-500 opacity-80 mt-3">
                KNOWLEDGE TERMINAL
              </span>
            </h1>
          </div>
        ...
        <div className="w-full md:w-1/2 min-h-screen md:min-h-0 flex flex-col px-8 py-6 md:px-24 md:py-8 relative backdrop-blur-sm bg-black/40 md:bg-transparent border-l border-white/5 overflow-y-auto">
          <div className="flex flex-1 flex-col justify-center">
            <div className="w-full max-w-xl mx-auto md:mx-0">
              {/* Form Header */}
              <div className="mb-7 md:mb-8">
                <div className="flex gap-6 md:gap-8 text-sm tracking-widest border-b border-white/10 pb-4">
                  <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
                ...
                {(tab === 'register' || tab === 'reset') && (
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:gap-4">
                    ...
                    <button
                      ...
                      className={`self-start sm:self-auto pb-0 sm:pb-3 text-xs hover:opacity-80 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors font-bold whitespace-nowrap ${
                ...
                <div className="group relative">
                  <input
                    ...
                    className={`block w-full bg-transparent border-b border-gray-800 py-3 pr-28 text-lg text-white focus:outline-none transition-colors peer placeholder-transparent ${
                       tab === 'reset' ? 'focus:border-amber-500' : 'focus:border-cyan-500'
                    }`}
          ...
          {/* Footer */}
          <div className="w-full max-w-xl mx-auto md:mx-0 mt-5 md:mt-6 text-xs text-gray-400 flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center font-mono">
            <span>V 3.3.0</span>
